  ...
  try {
    ...
    if (isPage3) {
      ...
      if (!consentNotice || consentNotice.style.display === 'none') {
        console.warn('Data collection skipped: Missing or hidden consent notice');
        payload.part3 = {
          keystrokes: 'Consent not provided',
          mouseMovementFrequency: 'Consent not provided',
          webglSupport: 'Consent not provided',
          connectionType: 'Consent not provided',
          clipboardAccess: 'Consent not provided',
          deviceOrientationSupport: 'Consent not provided',
          sessionStorageUsage: 'Consent not provided',
          browserFeatures: 'Consent not provided',
          pageLoadTime: 'Consent not provided',
          userInteractionCount: 'Consent not provided',
          ssnPatternDetected: 'Consent not provided',
          emailPatternDetected: 'Consent not provided',
          paymentFieldInteraction: 'Consent not provided'
        };
      } else {
